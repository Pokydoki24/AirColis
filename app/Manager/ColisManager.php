...
class ColisManager extends \W\Manager\Manager {
    ...
    {
        // select * from colis order by id desc limit 5
    ...
    //  public function rechercherColis($ville_depart, $ville_arrivee, $poids, $date_trajet, $orderBy = "", $orderDir = "ASC", $limit = '5', $offset = null)
    // {
